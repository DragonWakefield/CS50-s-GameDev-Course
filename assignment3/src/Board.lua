    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            if level == 1 then 
                ...
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(14),1))
            else
            
                table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(14), math.random(6)))
            end 
        end
    end
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                if level ~= 1 then
                    tilepos = math.random(6)

                end
                local tile = Tile(x, y, math.random(18), tilepos)
