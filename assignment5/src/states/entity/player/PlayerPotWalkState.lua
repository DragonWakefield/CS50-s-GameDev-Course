...
function PlayerPotWalkState:update(dt)
    ...
    elseif love.keyboard.wasPressed('e') and self.entity.pot_touch and not self.entity.pot_hold then
        self.entity:changeState('potup')
    elseif love.keyboard.wasPressed('r') and self.entity.pot_hold then
       -- gSounds['sword']:stop()
        --gSounds['sword']:play()
        self.entity.pot.state = 'picked'
        self.thrown = Projectile(self.entity.direction, self.entity.pot, self.dungeon)
