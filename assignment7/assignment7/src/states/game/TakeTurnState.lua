    ...
    :finish(function()
        ...
        function()
            ...
            Timer.after(1.5, function()
                ...
                --math.min(self.playerPokemon.currentExp + exp, self.playerPokemon.expToLevel)
                Timer.tween(0.5, {
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        gStateStack:push(LevelupMenu(self.playerPokemon))
                        ...
                        function()
                           ...
                           -- gStateStack:pop()
                            --gStateStack:push(NewLevelMenu(self.playerPokemon))
